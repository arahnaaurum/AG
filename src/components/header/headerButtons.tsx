...
function HeaderButtons({ children }: HeaderButtonsProps) {
  ...
  return (
    <div className="header__btn_container">
      <div>
        <Link className={`header__btn ${path === "/" && "hidden"}`} to="/" >
          Назад
        </Link>
        <Link to="/" >
          <svg width="7" height="14" viewBox="0 0 7 14" fill="none" xmlns="http://www.w3.org/2000/svg" className="header__icon">
      ...
      <div onClick={logOut}>
        ...
        <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg" className="header__icon">
